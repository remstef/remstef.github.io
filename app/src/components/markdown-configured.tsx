  ...
  return (
    <Markdown
      ...
      components={{
        ...
        h2: ({ node, ...props }) => (
          <h2 className="text-3xl font-bold mt-7 mb-3" {...props} />
        ),
        h3: ({ node, ...props }) => (
          <h3 className="text-2xl font-bold mt-6 mb-2" {...props} />
        ),
        h4: ({ node, ...props }) => (
          <h4 className="text-xl font-bold mt-5 mb-2" {...props} />
        ),
        h5: ({ node, ...props }) => (
        ...
        li: ({ node, ...props }) => (
          <li className="ml-4 -indent-4" {...props} />
        ),
        a: ({ node, ...props }) => (
          <a
        ...
        code: ({ node, ...props }) => (
          <code
            className="block bg-gray-900 text-gray-100 p-4 rounded mb-2 overflow-x-auto font-mono text-sm"
            {...props}
          />
        ),
        ...
        table: ({ node, ...props }) => (
          <table
            className="border-collapse border border-gray-400 w-full mb-2"
            {...props}
          />
        ),
        thead: ({ node, ...props }) => (
